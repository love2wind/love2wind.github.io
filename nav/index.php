    ...
    <div class="list closed">
        <ul>
          ...
          <!------>
            ...
            <li><a rel="nofollow" href="https://www.tangguoya.com/" target="_blank"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-temai"></use></svg>糖果鸭</a></li>
            <li><a rel="nofollow" href="https://www.tangguoya.com" title="糖果鸭博客>>" target="_blank"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-99"></use></svg>拼多多</a></li>
          ...
          <!------>
            ...
            <li><a rel="nofollow" href="https://www.tangguoya.com/" target="_blank"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-msg"></use></svg>糖果鸭</a></li>
...
<script src="https://widget.heweather.net/simple/static/js/he-simple-common.js?v=1.1"></script>
    ...
    <div id="content">
        <div class="con">
            <div class="shlogo" style="background: url() no-repeat center/cover;"></div>
            <div class="sou">
        ...
        <div class="foot">© 2020-<?php echo date("Y") ?> by <a href="https://www.tangguoya.com/">皮皮歪</a> . All rights reserved.</div>
    </div>
<!--
作者:PP·Y
